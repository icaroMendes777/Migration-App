<!-- DEFINE PARAMETROS -->
<?
DEFINE ('PAGINA',"ANXI3 ");  // CAMINHO+NOME DO ARQUIVO SEM EXTENSAO
...
<p class=Tit3 align=center style='text-align:center'><b>Anguttara Nikaya XI.3 </b></Tit3>
<p class=Tit1 align=center style='text-align:center'> Upanisa (pathama) Sutta </Tit1>
<p class=Tit1 align=center style='text-align:center'> Condição </Tit1>
...
<p class=Normal>Os equivalentes em Pali para alguns dos termos:<br>
virtude - <i>sila</i><br>
...
<p class=Normal><a href="ANXI.7.php"><b> >> Próximo Sutta</b></a></p>
