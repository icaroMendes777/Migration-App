<!-- DEFINE PARAMETROS -->
<?
DEFINE ('PAGINA',"SNXXII157 ");  // CAMINHO+NOME DO ARQUIVO SEM EXTENSAO
...
<p class=Tit3 align=center style='text-align:center'><b>Samyutta Nikaya XXII.157</b></Tit3>
<p class=Tit1 align=center style='text-align:center'>Abhinivesa (pathama) Sutta </Tit1>
<p class=Tit1 align=center style='text-align:center'>Aderência </Tit1>
...
adesão a quê, os grilhões, aderências e as prisões surgem?”[<a href="#N1">1</a>]<o:p></o:p></span></p>



<p class=Normal><a name=R1></a><span lang=PT-BR style='mso-ansi-language:
PT-BR'>“Venerável senhor, os nossos ensinamentos têm o Abençoado como origem,
como guia e como refúgio. Seria bom se o Abençoado pudesse explicar o
significado dessas palavras. Tendo ouvido do Abençoado, os bhikkhus o
recordarão.”<o:p></o:p></span></p>



<p class=Normal><span lang=PT-BR style='mso-ansi-language:PT-BR'>“Quando
existe a forma, bhikkhus, através do apego à forma, devido à adesão à forma,
surgem os os grilhões, aderências e as prisões. Quando existe a sensação ... percepção ...
formações volitivas ... consciência, através do apego à consciência, devido à adesão à
consciência, surgem os grilhões, aderências e as prisões.<o:p></o:p></span></p>
...
apego àquilo que é impermanente, sofrimento e sujeito a mudanças, os grilhões,
aderências e as prisões poderiam surgir?”<o:p></o:p></span></p>
...
<p class=Normal><span lang=PT-BR style='mso-ansi-language:PT-BR'>“Vendo dessa
maneira, o nobre discípulo bem instruído se desencanta com a forma, desencanta
com a sensação, desencanta com a percepção, desencanta com as formações volitivas,
desencanta com a consciência. Desencantado ele se torna desapegado. Através do
...
PT-BR'>[1] Aderências, (<i>abhinivesa</i>), são a cobiça, presunção e idéias;
prisões, (<i>vinibandha</i>), é a sujeição por não estar desprovido de cobiça
pela forma, etc. [<a href="#R1">Retorna</a>]<o:p></o:p></span></p>


<p class=Normal><a href="SNXXII.158.php"><b> >> Próximo Sutta</b></a></p>
